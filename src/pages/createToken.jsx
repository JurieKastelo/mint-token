...
function CreateToken() {
  ...
  async function createToken() {
    setDeploying(true); // Set deploying to true when creating token
    ...
    try {
      ...
      setDeploying(false); // Set deploying to false when token is deployed
    } catch (error) {
      console.error("Error deploying token:", error);
      setDeploying(false); // Set deploying to false if there's an error
    }
  }
